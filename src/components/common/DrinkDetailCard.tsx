  ...
  return (
    <Card >
        <CardContent onClick={onCardClick}>
            <img src={item.imgUrl} alt={item.name} style={{width: '80px', height:'100px'}}/>
                ...
                <Flex gap='7px' direction='column'>
                    ...
                    <Flex gap='4px' direction='column'>
                        ...
                        <Flex gap='8px'>
                            ...
                            <div style={{fontSize:'10px'}}>|</div>
                            <div style={{fontSize:'10px', width:'127px', wordBreak:'break-all'}}>{item.brewerId}</div>
                        </Flex>
                    </Flex>
                </Flex>
                <Flex gap='3px'>
                    {item.tags.map((tag,idx)=>{
                        return(
                            <TagButton key={idx} text={tag} onClick={()=>{}}/>
                        )
                    })}
                </Flex>
            </Flex>
